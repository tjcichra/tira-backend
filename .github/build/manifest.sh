...
ghcr.io/tjcichra/tira_backend:${TIRA_SHA} \
ghcr.io/tjcichra/tira_backend_arm64:${TIRA_SHA}
docker manifest annotate ghcr.io/tjcichra/tira_backend:${TIRA_SHA} \
ghcr.io/tjcichra/tira_backend_amd64:${TIRA_SHA} --arch amd64
docker manifest annotate ghcr.io/tjcichra/tira_backend:${TIRA_SHA} \
ghcr.io/tjcichra/tira_backend_arm64:${TIRA_SHA} --arch arm64
docker manifest inspect ghcr.io/tjcichra/tira_backend:${TIRA_SHA}
