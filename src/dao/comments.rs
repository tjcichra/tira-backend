...
use crate::{TiraDbConn, models::patch::UpdateComment};
use crate::diesel::ExpressionMethods;
use crate::diesel::RunQueryDsl;

/// DAO function for updating a comment by id.
pub async fn update_comment_by_id(conn: &TiraDbConn, comment: UpdateComment, comment_id: i64) -> QueryResult<usize> {
