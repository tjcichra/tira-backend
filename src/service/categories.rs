...
pub async fn archive_category_by_id(conn: &TiraDbConn, category_id: i64) -> Result<(), TiraMessage> {
...
pub async fn get_categories(conn: &TiraDbConn, filter_archived: Option<bool>) -> Result<Vec<Category>, QueryError> {
