...
use lettre::{SmtpTransport, Transport, transport::smtp::authentication::Credentials, message::{MultiPartBuilder, header::{ContentType, ContentTransferEncoding}, Body, Attachment, SinglePart}, Message};

use crate::models::{User, Ticket};
...
pub fn create_assignment_email_text(assigner: User, ticket: Ticket) -> String {
    ...
    format!("<p>{} assigned you to ticket '{}'.</p><p><a href=\"{}/{}\">Link to ticket</a></p>", assigner_string, ticket.subject, env::var("TIRA_EMAIL_TICKET_LINK").unwrap(), ticket.id)
}
